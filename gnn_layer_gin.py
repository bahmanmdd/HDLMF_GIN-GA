...
class GINLayer(nn.Module):
    ...
    def __init__(self, apply_func, aggr_type, dropout, batch_norm, residual=True, init_eps=0, learn_eps=False):
        super().__init__()
    ...
    def forward(self, g, h):
        ...
        # replacing edge weights with cap/fftt
        g.edata['w1'] = g.edata['feat'][:, 0]/g.edata['feat'][:, 1]
        # g.edata['w1'] = g.edata['feat'][:, 0]
        # neighbourhood aggregation
        g.update_all(fn.u_mul_e('h', 'w1', 'm'), self._reducer('m', 'neigh'))
        # update node based on neighbours
